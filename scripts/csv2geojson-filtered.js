...
// read file as string
fs.readFile('project-files/MDOT_Carpool_Lots.csv', 'utf-8', (err, csvString) => {
    ...
    csv2geojson.csv2geojson(csvString, {
        ...
        // write file
        fs.writeFile('data/mdot-carpool-lots-filtered.json', JSON.stringify(filteredGeoJson), 'utf-8', (err) => {
